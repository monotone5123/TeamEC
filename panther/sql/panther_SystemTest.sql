...
( 3, 3,"俺か、俺以外か","おれかおれいがいか","俺か、俺以外かの商品詳細",2,1500,"./images","book3.png",now(),"sophia_company",1,now(),now()),
...
/*( 20,20,"Bad_Guy","ばっどがい","Bad_Guyの商品詳細",5,1280,"./images","CD5.png",now(),"sophia_company",1,now(),now())*/
;
